    ...
    <div className="container">
      ...
      <section className="section">
        <div className="grid-3">
          ...
          <Leader name="Bhaskar Rai" title="Director" link="https://www.linkedin.com/in/raibhaskar" photoSrc={"https://drive.google.com/thumbnail?id=1Uq6pWZJ8r6Wbq3y1xwbhaskar&sz=w800"}>
